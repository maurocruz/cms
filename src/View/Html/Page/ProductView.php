...
class ProductView implements ViewInterface {
    ...
    public function edit(array $data): array {
        ...
        // FORM
        $this->content['main'][] = self::divBox($value['name'], "product", [ self::formProduct("edit", $value) ]);
        // IMAGES
    ...
    public function new($data = null): array {
        $this->navbarProduct();
        $this->content['main'][] = self::divBox(_("Add new"), "product", [ self::formProduct() ]);
        return $this->content;
    }

    private function formProduct($case = "new", $value = null): array {
        // id
