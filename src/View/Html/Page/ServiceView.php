...
class ServiceView implements ViewInterface {
    ...
    private function serviceForm($case = "new", $value = null): array {
        ...
        // NAME
        $content[] = self::fieldsetWithInput(_("Service name"), "name", $value['name'] ?? null, [ "style" => "width: 70%; "]);
        // ADDITIONAL TYPE
        $content[] = self::fieldsetWithInput(_("Additional type"), "additionalType", $value['additionalType'] ?? null, [ "style" => "width: 30%; "]);
        // DESCRIPTION
        ...
        // SERVICE TYPE
        $content[] = self::fieldsetWithInput(_("Service type"), "serviceType", $value['serviceType'] ?? null, [ "style" => "width: 100%; "]);
        // TERMS OF SERVICE
