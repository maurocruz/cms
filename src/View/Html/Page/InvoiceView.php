...
class InvoiceView implements ViewInterface
{
    ...
    private static function formInvoice($value = null, $n = "+"): array
    {
        ...
        // TOTAL PAYMENT DUE
        $content[] = self::fieldsetWithInput(_("Total payment due"), "totalPaymentDue", $value['totalPaymentDue']);
        // PAYMENT DUE DATE
        $content[] = self::fieldsetWithInput(_("Payment due date"), "paymentDueDate", $value['paymentDueDate'], [], "date");
        // PAYMENT DATE
        $content[] = self::fieldsetWithInput(_("Payment date"), "paymentDate", $value['paymentDate'], [], "date");
        // PAYMENT STATUS
        $content[] = self::fieldsetWithSelect(_("Payment status"), "paymentStatus", $value['paymentStatus'], [
