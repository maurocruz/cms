...
class Box
{
	private const CLASS_DROPDOWN_CONTRACTED = 'button-dropdown button-dropdown-contracted';
	private const CLASS_DROPDOWN_EXPANDED = 'button-dropdown button-dropdown-expanded';
	private const CLASS_BOX_EXPANDING = 'box box-expanding';
	...
	public function expandingBoxWithoutContent(string $caption, string $class = null): string
	{
		$id = $this->generateRandomId();
		$classBox = trim(self::CLASS_BOX_EXPANDING . " $class");
		...
		$div->content("<p class='" . self::CLASS_DROPDOWN_CONTRACTED . "' onclick='expandBox(this,\"$id\");' style='width: 100%;'>$caption</p>");
