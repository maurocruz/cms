...
class Structure
{
	...
	public static function head(): string
  {
    ...
    $returns = '<meta charset="UTF-8">';
	  ...
	  $returns .= '<script src="https://plinct.local/static/dist/plinct-shell/3.2/main.js"></script>';
  ...
  public static function header(): string
  {
    ...
    return '<p style="display: inline;"><a href="/admin" style="font-weight: bold; font-size: 200%; margin: 0 10px; text-decoration: none; color: inherit;">' . App::getTitle() . '</a> ' . _("Control Panel") . '. Api: ' . $apiLocation .". ". App::getVersion() . '</p>';
  }
