...
abstract class OrderItemWidget {
    ...
    protected function listSellerOfferedItems($sellerHasOfferCatalog): array {
        ...
        foreach ($sellerHasOfferCatalog['itemListElement'] as $key => $value) {
            ...
            $price = $item['priceCurrency'] . " " . number_format($item['price'],2,',','.');
            ...
            // REFERENCE ORDER
            $content[] = self::input("items[$key][referencesOrder]", "hidden", $this->referencesOrder);
            // OFFER
