...
class ThingComponentView
{
	public static function formThing(Form $form, array $value = null, string $nameOfName = null, array $excludes = []): Form
	{
		...
		// Expandig box
		$form->content(ComponentFactory::box()->expandingBoxWithoutContent(_("Thing"), "form-thing", true));
		...
		// description
		$form->content(
			ComponentFactory::box()->expandingBox(_('Description'),"<textarea name='description' class='thing-description' id='description$idthing' style='min-height: 300px;'>$description</textarea>", false,'width: 100%;')
		);
